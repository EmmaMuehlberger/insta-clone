<template>
	<div class="Page">
		<div class="Page__main ProfilePage">
		...
		<PostModul v-if="showPostModul && currentUser.id !== user.id" :prompt="`Unfollow @${user.name}?`" :fields="fields" @onCloseModul="togglePostModul" @onUnfollow="unfollowUser" />
		<PostModul v-if="showPostModul && currentUser.id == user.id" :prompt="null" :fields="ownProfileFields" @onCloseModul="togglePostModul" />
	</div>
</template>
...
export default {
	data() {
		return {
			...
			showPostModul: false,
			fields: [
				{content: "Unfollow", bold: true, action: true},
			],
			ownProfileFields: [
				{content: "Change password", bold: false, action: false},
				{content: "Nametag", bold: false, action: false},
				{content: "Apps and Websites", bold: false, action: false},
				{content: "Notifications", bold: false, action: false},
				{content: "Privacy and Security", bold: false, action: false},
				{content: "Login Activity", bold: false, action: false},
				{content: "Emails from Instagram", bold: false, action: false},
				{content: "Report a Problem", bold: false, action: false},
			]
		}
	},
	head() {

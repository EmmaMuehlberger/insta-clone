<template>
	<div class="AccountMenuOverlay" @click="closeMenu">
		<div class="AccountMenu">
			<div class="AccountMenu__arrow"></div>
			<nuxt-link :to="`/user/${currentUser}`">
				<div class="AccountMenu__item">
			...
			<div class="AccountMenu__item">
				<svg aria-label="Saved Posts" class="_8-yf5 " color="#262626" fill="#262626" height="16" role="img" viewBox="0 0 24 24" width="16"><polygon fill="none" points="20 21 12 13.44 4 21 4 3 20 3 20 21" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></polygon></svg>
				<p>Saved</p>
			</div>
			<div class="AccountMenu__item">
...
<style scoped lang="scss" src="./AccountMenu.scss"></style>